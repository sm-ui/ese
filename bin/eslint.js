...
process.on("uncaughtException", function(err){
    ...
    if (typeof err.messageTemplate === "string" && err.messageTemplate.length > 0) {
        var template = lodash.template(fs.readFileSync(path.resolve(__dirname, "eslint/messages/" + err.messageTemplate + ".txt"), "utf-8"));
...
if (useStdIn) {
    ...
    var configInit = require("eslint/lib/config/config-initializer");
